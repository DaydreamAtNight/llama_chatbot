<template>
  <el-container height="10vh" >
  <el-header>
    <div>
      <span><img src="./assets/panda-bear.png" alt="" height="40px"/></span>
        <span>Chatbot</span>
    </div>
    <el-button type="info" @click="setting">Setting</el-button>
  </el-header>
  <el-container>
  <el-aside width="15%">
      <el-menu default-active="1" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" >
        <el-menu-item index="1">
          ...
          <span slot="title">7B</span>
        </el-menu-item>
        <el-menu-item index="2">
          <i class="el-icon-document"></i>
          <span slot="title">13B</span>
        </el-menu-item>
        <el-menu-item index="3" disabled>
          <i class="el-icon-document" ></i>
          <span slot="title">33B</span>
        </el-menu-item>
        <el-menu-item index="3" disabled>
          <i class="el-icon-document" ></i>
          <span slot="title">65B</span>
        </el-menu-item>
      </el-menu>
    </el-aside>
  <el-main>
...
import UsrIcon from './assets/bear.png'
export default {
  name: 'App',
  components: {
    BotIcon,
  ...
  methods: {
    ...
    loadHistory () {
      return { 
        // 消息数据，字段如下，应以时间的倒序给出。
        messages: [
          { text: "Do not prompt with \"What is the meaning of life? Be concise and do not repeat yourself.\" but with \"I believe the meaning of life is\"", time: new Date(), direction: 'received' },
          { text: "Do not prompt with \"Explain the theory of relativity.\" but with \"Simply put, the theory of relativity states that\" ", time: new Date(), direction: 'received' },
          { text: "Do not prompt with \"Ten easy steps to build a website...\" but with \"Building a website can be done in 10 simple steps:\"", time: new Date(), direction: 'received' },
          { text: "Any notes before I start?", time: new Date(), direction: 'sent' },
